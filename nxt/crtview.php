                                ...
                                <div class="col-xs-9">
                                    <div class="huge text-right"><?php echo $link; ?></div>
                                        <div class="btn-group pull-right">
                                            <button type="button" class="btn btn-success btn-sm btn-lng dropdown-toggle" data-toggle="dropdown">More
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <li><a href="<?php echo $_SERVER['PHP_SELF'].'?link='.$link.'&todo=delete'; ?>">Delete</a>
                                                </li>
                                                <li><a href="<?php echo 'assedit.php?link='.$link.'&todo=deactivate'; ?>">Edit</a>
                                                </li>
                                                <li class="divider"><hr></li>
                                                <li><a href="<?php echo 'go.php?user='.$user.'&link='.$link.'&to=compress'; ?>">Get Compressed File</a>
                                                <li><a href="<?php echo 'go.php?user='.$user.'&link='.$link.'&to=excel'; ?>">Get Spreadshet</a>
                                                </li>
                                            </ul>
                                        </div>
	                                </div>
